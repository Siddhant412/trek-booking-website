...
<head>
    ...
    <title>payment-garbett-prod</title>
...
<header>
    ...
    <div class="testbox">
        <form action="/Mini Project/garbettprod2checkout_2.php">
          <div class="banner">
          ...
          <div class="item">
            ...
            <div class="btn-block">
              <button type="submit" href="/Mini Project/garbettprod2checkout_2.php">Buy</button>
            </div>
        </form>
        </div>
</body>
