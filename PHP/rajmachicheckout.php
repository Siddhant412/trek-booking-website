<?php>
  ...
  $query = SELECT id FROM customer WHERE password= $_SESSION['Password'] AND mail= $_SESSION['Email']
  $result_cust_id = mysqli_query($conn, $query);

  $cust_id = $result_cust_id 
  $event_price = 5000
  $event_location = "Rajmachi"
...
<header>
    ...
    <div class="testbox">
        <form action="rajmachicheckout_2.php">
          <div class="banner">
          ...
          <div class="item">
            ...
            <div class="btn-block">
              <button type="submit" href="/Mini Project/rajmachicheckout_2.php">Book</button>
            </div>
        </form>
        </div>
</body>
